...
{
    public static UnityEvent SaveAllWhoNeedSave = new UnityEvent();
    static bool initialised = false;
    public static bool CacheIsLoaded = false;
    ...
    public static void DeleteKeyPP(string key)
    {
#if UNITY_SWITCH
         cache.DeleteKey(key);
#else
    ...
    */
    ...
    public static void ES3DeleteKey(string key)
    {
#if UNITY_SWITCH && !UNITY_EDITOR
             cache.DeleteKey(key);
#else
